...
- Упоминай местные реалии: законы и правила КР, практику применения финансовых инструментов среди бухгалтеров. 
...
Не говори, что ты ИИ. 
Используй живой, понятный язык, добавляй местные примеры (Минфин КР, Налоговая служба, практика использования финансовых или аудиторских инструментов).
...
Оформляй статью в Markdown: заголовки, списки, цитаты, выделения, ссылки.`,
      ...
      {
        role: 'user',
        content: `Генерировать контент на тему '${newTopic}' в разных форматах, включая:

Статьи — глубокие исследования на тему, с подробным описанием, примерами, практическими кейсами.

Новости — актуальные и свежие новости или события, связанные с темой, с кратким изложением фактов и выводов.

Лайфхаки — полезные советы и трюки, которые могут упростить или улучшить процессы, связанные с темой.

Обзоры — детальные обзоры инструментов, технологий или практик, связанных с темой.

Советы для начинающих — пошаговые рекомендации или руководство для новичков в данной области.
...
Ссылки на ресурсы или инструменты.

Разделять каждый раздел на отдельные абзацы.

Включать примеры и кейсы из Кыргызстана или других реалистичных мест, если это применимо.

Тематика:

Подробно описывать проблемы и решения в сфере (указать конкретную сферу или тему, например, бухгалтерия, стартапы, управление проектами, маркетинг, технологии и т.д.).

Упоминать реальные (или реалистичные) примеры и кейсы из практики в Кыргызстане, если тема локальная, или использовать международный опыт.

Указывать плюсы и минусы использования различных инструментов, технологий, методов или подходов.

Давать советы начинающим специалистам, включая пошаговые инструкции, которые будут полезны новичкам в области.

Особенности:

Включать ссылки на практические ресурсы (например, сайты, онлайн-курсы, форумы, блоги, продукты), если это уместно для конкретной темы.

Рассматривать разные бухгалтерские инструменты или технологические решения, если это связано с темой.

Включать практические рекомендации и советы по внедрению инструментов, технологий или методик в бизнес-процессы, с примерами из практики.

Для новостей — актуализировать данные с учетом изменений в законодательстве, технологических трендов или событий, относящихся к теме.

Пример структуры контента:

Заголовок: Название статьи, новости, лайфхака и т.д.

Введение: Краткое введение в тему с пояснением актуальности и значимости.

Основное содержание:

Подразделы с заголовками, например, "Проблемы в бухгалтерии Кыргызстана", "Новые тренды в маркетинге", "Советы по запуску стартапа".

Разделы с практическими примерами из реальной жизни, включая кейсы.

Преимущества и недостатки технологий или инструментов.

Заключение: Подведение итогов, выводы, рекомендации.

Бонусный контент (если применимо):
...
Упоминание актуальных трендов или новых технологий.

Указание на возможности для оптимизации или улучшения процессов в данной области.

Разделение информации по уровням сложности, если это важно (например, для новичков и более опытных специалистов).

Пример запроса для каждой задачи:

Для статьи:
"Напишите статью на тему '${newTopic}' с подробным анализом, примерами из практики, а также плюсы и минусы использования инструментов в этой области. Статья должна содержать не менее 1500 слов, с использованием примеров из Кыргызстана."

Для новостей:
"Напишите новость на тему '${newTopic}', включая актуальные события и изменения, связанные с этой темой, с фокусом на последние новости из Кыргызстана и международный опыт."

Для лайфхаков:
"Напишите серию лайфхаков по теме '${newTopic}', которые помогут начинающим специалистам в этой области. Лайфхаки должны быть простыми и практичными, с реальными примерами и приложениями."

Для обзора:
"Напишите обзор на тему '${newTopic}', с анализом текущих инструментов, их плюсов и минусов, а также с примерами из бизнеса в Кыргызстане."

Для советов:
"Дайте советы для начинающих специалистов на тему '${newTopic}', включая практическое руководство по внедрению инструментов или технологий.`,
      },
    ],
  });
